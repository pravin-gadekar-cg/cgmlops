...
def preprocess_train_and_deploy(
    ...
    # application URL will be https://ind-coe.appspot.com/


@dsl.pipeline(
  name='CG MlOps',
  description='CG Mlops model on current data in GCS'
)
def train_and_deploy(
    ...
    # no need to redeploy web app at https://ind-coe.appspot.com/
